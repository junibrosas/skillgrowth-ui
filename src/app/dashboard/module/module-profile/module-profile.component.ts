...
export class ModuleProfileComponent implements OnDestroy, OnInit {
            ...
            course => {
                ...
                this.store.dispatch({
                    type: COMMON_BREADCRUMB_SET, payload: [
                        ...
                        { label: course.name, url: '/dashboard/course/' + course.id, params: [] },
        ...
        this.moduleService.getById(this.moduleId).subscribe(
            module => {
                ...
                this.store.dispatch({
                    type: COMMON_BREADCRUMB_SET, payload: [
                        { label: 'Subjects', url: '/dashboard/subject', params: [] },
                        { label: module.course.subject.name, url: '/dashboard/subject/' + module.course.subject.id, params: [] },
                        { label: module.course.name, url: `/dashboard/course/${module.course.id}`, params: [] },
    ...
    get overviewUrl() { return `/dashboard/module/overview/${this.moduleId}`; }
}
